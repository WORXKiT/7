...
#ki = KAMIKAZE(authToken='EvLV2qK6lkJPBWBvOXI6.YFTivvUQlJGyQ0q4WC5f5G.W7Tvs5t4FOLfP6L3/nJNrEDbhXC0lnpP62zUqAfszr8=')
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  cl.sendContact(op.param1, "u58ddf579a716b0454bf777cce43cbaaa")
...
#===========BOT UPDATE============#
                        elif cmd == "ndakuja" or text.lower() == '😆':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
