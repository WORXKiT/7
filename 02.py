...
cl.log("Channel Access Token : " + str(channelToken))
poll = OEPoll(cl)
#call = LineCall(cl)
...
#kk = KAMIKAZE(authToken='Evgzt2YDGu5j8fI6S7y0.HekonXOId0LOrlrdV8suWa.Za9/BK3lzl/gXPpsb+8XV/NuwKNbdF6FWPfC2rPf9j0=')
...
#kc = KAMIKAZE(authToken='EvFUiD2pfNELRC3Aer45.As29tpM17+gWKq/m5Yz8Xq.WebKAPovwWTLwdjnqmglCD8iV+zDDoDIsP7eOSE3fhc=')
...
#km = KAMIKAZE(authToken='EwMTHv3xaSSvn60tes8c.qXiB6k3zJEG+VPAZ98trJa.AuMcEd6vA5w6wiZfyxlFAwSAu2o/Jh0eN9DGZIOEmoo=')
...
#kb = KAMIKAZE(authToken='EwZD2TMWRC8DLQeUU9Z2.hmdPzUzp8pDxkggTRRJByG.TpUnBKD5WpzVyF1SLVgfHCRajdwHRf+PYj09TLQEj2s=')
...
#sw = KAMIKAZE(authToken='EvhD7rlI4FsSG4mjarXe.fi6AOZ9NS4Fsm3ey6B9rlG.IqporEXQK+RvUBPmwanuqAym2EBaTTbbN5tNNduoGIQ=')
...
creator = ["u58ddf579a716b0454bf777cce43cbaaa"]
owner = ["u58ddf579a716b0454bf777cce43cbaaa"]
admin = ["u58ddf579a716b0454bf777cce43cbaaa"]
staff = ["u58ddf579a716b0454bf777cce43cbaaa"]
    ...
    try:
        ...
        for i in mid:
            ...
            if no < len(mid):
                ...
                textx += "\n♦TOTAL {} PENGHUNI♦".format(str(len(mid)))
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                ret_ += str(md)
                                ry = str(arbots.displayName)
                                pesan = ''
                                pesan2 = pesan+"@x \n\n"
                                xlen = str(len(zxc)+len(xpesan))
                                xlen2 = str(len(zxc)+len(pesan2)+len(xpesan)-1)
                                zx = {'S':xlen, 'E':xlen2, 'M':arbots.mid}
                                zx2.append(zx)
                                zxc += pesan2
                            ...
                            if msg._from in admin:
                                ...
                                ma = "u58ddf579a716b0454bf777cce43cbaaa"
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                cl.sendMessage("u58ddf579a716b0454bf777cce43cbaaa", '.')
                                ...
                                text = xpesan + zxc + ret_ + ""
                                cl.sendMessage(to, text, contentMetadata={'MENTION':str('{"MENTIONEES":'+json.dumps(zx2).replace(' ','')+'}')}, contentType=0)
                                cl.sendContact(to, "u58ddf579a716b0454bf777cce43cbaaa")
                            except Exception as e:
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, str(e))
                        elif cmd.startswith("cekmid: "):
                            if msg._from in admin:
                                ardian = text.replace("cekmid: ","")
                                cl.sendMessage(msg.to, None, contentMetadata={'mid': ardian}, contentType=13)
                                ...
                                try:
                                    ...
                                    cl.sendImageWithURL(msg.to,image)
                                    cl.sendMessage(msg.to,"Cover Picture " + contact.displayName)
...
#===========Hiburan============#
                          ...
                          if msg._from in admin:
                            ...
                            with requests.session() as web:
                                ...
                                result = web.get("https://farzain.com/api/premium/yt_search.php?apikey=apikey_saintsbot&id={}".format(str(search)))
                                data = result.text
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              try:
                                  ...
                                  r = requests.get("https://dzin.com/api/screenshot/tablet.php?url={}".format(urllib.parse.quote(links)))
                                  data = r.text
                                  data = json.loads(data)
                          ...
                          if wait["selfbot"] == True:
                              if msg._from in admin:
                                  url = ("https://farzain.com/api/tiktok.php?apikey=EN6hLK6KAWCjSV2FDHvWTb81M")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                url = ("https://farzain.com/api/special/fansign/indo/viloid.php?apikey=vanseters&text="+nama)
                                cl.sendImageWithURL(msg.to, url)				
                            except Exception as error:
                                cl.sendMessage(msg.to, str(error))
                           else:
                               cl.sendMessage(msg.to, "Khusus member premium!")
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to,title+ author+ durasi+ suka+ rating)
                            except Exception as e:
                                cl.sendMessage(msg.to,str(e))
